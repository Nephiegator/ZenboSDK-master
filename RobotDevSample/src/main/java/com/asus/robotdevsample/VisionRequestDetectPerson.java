...
//        mBtnDetectPerson.setText(stringtemp);
    ...
    private void startDetectPerson() {
        // start detect person
        VisionConfig.PersonDetectConfig personDetectConfig = new VisionConfig.PersonDetectConfig();

        personDetectConfig.enableDebugPreview = true;
        personDetectConfig.intervalInMS = 1000;
        personDetectConfig.enableDetectHead = true;

        robotAPI.vision.requestDetectPerson(personDetectConfig);
